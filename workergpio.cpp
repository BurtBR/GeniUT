...
#define _GPIO_LED1 _GPIO26_OUTPUT
#define _GPIO_LED2 _GPIO9_OUTPUT
#define _GPIO_LED3 _GPIO22_OUTPUT
#define _GPIO_LED4 _GPIO6_OUTPUT
#define _GPIO_LED5 _GPIO5_OUTPUT
#define _GPIO_LED6 _GPIO21_OUTPUT
#define _GPIO_LED7 _GPIO20_OUTPUT
#define _GPIO_LED8 _GPIO27_OUTPUT
#define _GPIO_LED9 _GPIO4_OUTPUT
#define _GPIO_LED10 _GPIO25_OUTPUT
#define _GPIO_LED11 _GPIO24_OUTPUT
#define _GPIO_LED12 _GPIO23_OUTPUT
...
bool WorkerGPIO::GPIO_Init(){
    ...
    _GPIO_FSEL0 = (_GPIO_FSEL0 & (~_GPIO4_FSEL_Msk))|(_GPIO_FSEL_OUTPUT << _GPIO4_FSEL_Shift);
    _GPIO_FSEL0 = (_GPIO_FSEL0 & (~_GPIO9_FSEL_Msk))|(_GPIO_FSEL_OUTPUT << _GPIO9_FSEL_Shift);
